...
<div class="row">
				<div class="span12">
					<p>
						...
						<a class="btn btn-primary"
							href="?mask=ditta&amp;do=cercaDitta&amp;id=<?php echo stripslashes($id); ?>&amp;raggruppamento=<?php echo $maxRag; ?>"><i
							class="icon-plus icon-white"></i>&nbsp;Raggruppamento <?php echo $newRag; ?></a>
					</p>
				</div>
			</div>
